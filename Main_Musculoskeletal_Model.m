...
Model.Fc = [Model.X(43+1:43+3,1,1:n); ... % 3D ankle contact in foot SCS
    Model.X(43+6,1,1:n);Model.X(43+7,1,1:n); ... % Tibio-femoral medial and lateral contact in shank SCS
    Model.X(43+11:43+13,1,1:n); ... % 3D patello-femoral contact in patella SCS
    Model.X(43+15:43+17,1,1:n)]; % 3D hip contact in thigh SCS

% Ligament forces (tensile forces > 0)
% About lines of action
Model.Fl = [Model.X(43+4:43+5,1,1:n); ... % TiCaL, CaFil
    Model.X(43+8:43+10,1,1:n); ... % ACL, PCL, MCL
    Model.X(43+14,1,1:n)]; % PT

% Bone forces (compression forces > 0)
% About segment Y axis
Model.Fb = Model.X(43+18:43+21,1,1:n); % Foot, tibia, patella, femur axial
